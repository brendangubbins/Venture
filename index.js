...
app.use(cors({ origin: 'https://www.venture-ctp.herokuapp.com', credentials: true }));
...
app.get(
  ...
  passport.authenticate('google'),
  (request, response) => {
    response.redirect('https://www.venture-ctp.herokuapp.com/Dashboard'); // redirect the user to their dashboard after login
  }
);
